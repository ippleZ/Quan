...
var __assign = function() {
	...
	function(e) {
		for (var r, n = 1,
		t = arguments.length; n < t; n++) for (var o in r = arguments[n]) Object.prototype.hasOwnProperty.call(r, o) && (e[o] = r[o]);
		return e
	},
...
function __decorate(e, r, n, t) {
	...
	else for (var l = e.length - 1; l >= 0; l--)(o = e[l]) && (h = (a < 3 ? o(h) : a > 3 ? o(r, n, h) : o(r, n)) || h);
	return a > 3 && h && Object.defineProperty(r, n, h),
	h
}
		...
		return function(l) {
			return function(a) {
				...
				for (; h;) try {
					...
					return: a[0] ? t.
					throw || ((o = t.
					return) && o.call(t), 0) : t.next) && !(o = o.call(t, a[1])).done) return o;
...
function __spreadArrays() {
	for (var e = 0,
	r = 0,
	n = arguments.length; r < n; r++) e += arguments[r].length;
	var t = Array(e),
	o = 0;
	for (r = 0; r < n; r++) for (var a = arguments[r], h = 0, l = a.length; h < l; h++, o++) t[o] = a[h];
	return t
}
function __spreadArray(e, r, n) {
	if (n || 2 === arguments.length) for (var t, o = 0,
	a = r.length; o < a; o++) ! t && o in r || (t || (t = Array.prototype.slice.call(r, 0, o)), t[o] = r[o]);
...
function __asyncGenerator(e, r, n) {
	...
	function l(e, r) {
		try { (n = o[e](r)).value instanceof __await ? Promise.resolve(n.value.v).then(i, u) : S(a[0][2], n)
		} catch(e) {
			S(a[0][3], e)
		}
		var n
...
function __asyncValues(e) {
	...
	return n ? n.call(e) : (e = "function" == typeof __values ? __values(e) : e[Symbol.iterator](), r = {},
	t("next"), t("throw"), t("return"), r[Symbol.asyncIterator] = function() {
		return this
	},
	r);
	function t(n) {
		r[n] = e[n] &&
		function(r) {
			return new Promise((function(t, o) { (function(e, r, n, t) {
...
function __importStar(e) {
	...
	var r = {};
	if (null != e) for (var n in e)"default" !== n && Object.prototype.hasOwnProperty.call(e, n) && __createBinding(r, e, n);
	return __setModuleDefault(r, e),
	r
}
...
function __classPrivateFieldSet(e, r, n, t, o) {
	...
	return "a" === t ? o.call(e, n) : o ? o.value = n: r.set(e, n),
	n
}
...
function reName(e, r, n, t) {
	...
	a = r.locationList, h = r.modifiedList, l = r.deleteList, i = 0; i < l.length; i++) {
		if (new RegExp(l[i].reg, "gi").test(e)) {
			o.modified = l[i].enShort,
			o.action = "delete";
			break
		}
	}
	for (i = 0; i < a.length; i++) {
		var u = a[i].flag && !a[i].ignoreFlag ? "".concat(a[i].flag, "|").concat(a[i].reg) : a[i].reg;
		if (new RegExp(u, "gi").test(e)) { ["enShort", "enFull", "zh", "enShortThree"].includes(n) ? o.location = a[i][n] || a[i].enShort: o.location = a[i].custom || a[i].enFull,
			o.flag = a[i].flag || "🏴‍☠️";
			break
		}
	}
	for (i = 0; i < h.length; i++) {
		if (new RegExp(h[i].reg, "gi").test(e)) { ["enShort", "enFull", "zh"].includes(t) ? o.modified = h[i][t] : o.modified = h[i].custom || h[i].enShort,
...
function operator(e) {
	...
	n = {},
	t = $arguments.airport,
	o = void 0 === t ? "": t, a = $arguments.test, h = void 0 !== a && a, l = $arguments.template, i = void 0 === l ? "{flag}「{airport}」{location} {modified} {number}": l, u = $arguments.location, S = $arguments.modified, g = [], c = [], f = 0; f < e.length; f++) {
		var s = e[f],
		T = getNum(s.name),
		...
		if ("delete" !== F.action) {
			...
			n[z] ? (n[z] += 1, s.name = z + "_" + n[z]) : (n[z] = 1, s.name = z),
			c.push(s),
			g.push(__assign(__assign({},
			F), s))
		} else g.push(__assign(__assign({},
		F), s))
	}
	return h ? g: c
}
function getProxyName(e, r, n, t) {
	...
	l = r.modified || "",
	i = r.origin || "";
	return e = (e = (e = (e = (e = (e = e.replace(/\{airport\}/g, a)).replace(/\{flag\}/g, o)).replace(/\{location\}/g, h)).replace(/\{modified\}/g, l)).replace(/\{number\}/g, n)).replace(/\{origin\}/g, i)
}
