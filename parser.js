...
var para = /^(http|https)\:\/\//。
test(link0) ? link0 : content0.split("\n")[0];
var para1 = para.slice(para.indexOf("#") + 1)。 replace(/\$type/g，
    "node_type_para_prefix")。 replace(/\$emoji/g，
    "node_emoji_flag_prefix")。 replace(/\$tag/g，
    "node_tag_prefix")。 replace(/\$index/g，
    "node_index_prefix") //防止参数中其它位置也存在"#"
